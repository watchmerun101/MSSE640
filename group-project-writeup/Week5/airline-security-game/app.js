...
const DEFAULT_DECISION_TABLE = [
  ...
  },
  {
    ...
    conditions: { weightOk: "F", liquidOk: "T", containersOk: "T", noProhibited: "T", validPass: "T" },
    action: "HOLD",
  },
  {
    id: "R3",
    title: "Rainy Day — Too much liquid",
    conditions: { weightOk: "T", liquidOk: "F", containersOk: "T", noProhibited: "T", validPass: "T" },
    action: "HOLD",
  },
  {
    id: "R4",
    title: "Rainy Day — Too many containers",
    conditions: { weightOk: "T", liquidOk: "T", containersOk: "F", noProhibited: "T", validPass: "T" },
    action: "HOLD",
  },
  {
    id: "R5",
    title: "Rainy Day — Prohibited item",
    conditions: { weightOk: "T", liquidOk: "T", containersOk: "T", noProhibited: "F", validPass: "T" },
    action: "HOLD",
  },
  {
    id: "R6",
    title: "Rainy Day — Invalid boarding pass",
    conditions: { weightOk: "T", liquidOk: "T", containersOk: "T", noProhibited: "T", validPass: "F" },
    action: "HOLD",
  },
  {
    id: "R7",
    title: "Rainy Day — Multiple failures",
    conditions: { weightOk: "F", liquidOk: "F", containersOk: "F", noProhibited: "F", validPass: "F" },
    action: "HOLD",
  },
];
...
function evaluatePairwiseGuidedCase() {
  ...
  setBanner(`Evaluated pairwise guided case. Table returned ${tableResult.verdict}, policy returned ${policyResult}.`);
  refreshStats();
}
...
function bindEvents() {
  ...
  dom.evaluatePairwiseGuidedBtn.addEventListener("click", evaluatePairwiseGuidedCase);
...
function initialize() {
  ...
  refreshStats();
  bindEvents();
  setBanner("Editable decision table ready. Turn on Educator Mode for guided input.");
}
